            ...
            {sponsors.map((sponsor, index) => (
              ...
              >
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-center text-sm mt-3">{sponsor.name}</CardTitle>
                </CardHeader>
                {sponsor.website && (
                  <CardContent className="pt-0 pb-4">
                    <a
                      ...
                      className="flex items-center justify-center gap-1 text-primary hover:underline text-xs"
                    >
